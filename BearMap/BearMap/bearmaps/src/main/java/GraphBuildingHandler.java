...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeState = "node";
            Node node = new Node(Long.parseLong(attributes.getValue("id")),
            ...
            thisn = g.getMap().get(Long.parseLong(attributes.getValue("ref")));
            if (lastnode != null) {
                Edge e = new Edge(lastnode, thisn);
                connected.add(e);
            }
            lastnode = thisn;
            ...
            LocationParams loc = new LocationParams(g.lat(prev.id),
                    g.lon(prev.id),
                    attributes.getValue("v"), prev.id);
        }
    }
